...
\end{equation}
The first order partial derivatives of the log-likelihood for
...
fragmented by chain rule to
\begin{equation}
\frac{\partial l(\boldsymbol{\vartheta} | \mathbf{y})}{\partial \boldsymbol{\vartheta}_k} =
  \sum_{i = 1}^n \frac{\partial l(\boldsymbol{\vartheta} | y_i)}{\partial \eta_{ik}}
  \frac{\partial \eta_{ik}}{\partial \boldsymbol{\vartheta}_k} = 
  \sum_{i = 1}^n \frac{\partial l(\boldsymbol{\vartheta} | y_i)}{\partial \theta_{ik}}
  \frac{\partial \theta_{ik}}{\partial \eta_{ik}}\frac{\partial \eta_{ik}}{\partial \boldsymbol{\vartheta}_k}.
\end{equation}
...
\begin{equation}
\frac{\partial^2 l(\boldsymbol{\vartheta} | \mathbf{y})}{\partial \boldsymbol{\vartheta}_k \partial 
\boldsymbol{\vartheta}_s^\top} = \frac{\partial s(\boldsymbol{\vartheta})}{\partial
\boldsymbol{\vartheta}_s^\top} = \sum_{i = 1}^n \frac{\partial \eta_{is}}{
\partial \boldsymbol{\vartheta}_s}
\frac{\partial^2 l(\boldsymbol{\vartheta} | y_i)}{\partial \eta_{ik}\partial \eta_{is}}
\frac{\partial \eta_{ik}}{\partial \boldsymbol{\vartheta}_k}
\end{equation}
for $s = 1, \ldots, K$.
