...
a faster development time, but also to provide already familiar users with a toolset, that even 
beside the possibility to formulate STAR models directly, easily allows to use and reanalyze 
