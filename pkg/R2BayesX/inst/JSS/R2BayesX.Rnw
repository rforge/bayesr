...
flexible MCMC samplers and the data management/efficiency, STAR models usually run very long and 
show inferior sampling properties. A detailed comparison of \pkg{BayesX} with other software
packages including \pkg{WinBUGS} is provided in
