...
\end{center}
\end{table}
Specifying additional arguments for a model term is generally restricted to 
argument \code{xt} within function \fct{s} and \fct{r}, i.e. \code{xt} must be a named \code{list}
