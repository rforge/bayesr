...
fm2 <- update(fm1, . ~ . + sx(id, bs = "gs", map = BeechBnd, nrknots = 20))
@
...
<<fit-forest-model-02>>
@
Note that argument \code{nrknots} is set to 20 for exact replication of the analysis. Taking a look
at model information criteria
