...
\renewcommand{\labelitemi}{\raisebox{0.9mm}{\tiny$\bullet$}}
\renewcommand{\labelitemii}{--}

%%%%%%%%%%%%%%%%%%%%%%%%%
% Abstaende in Tabellen %
%%%%%%%%%%%%%%%%%%%%%%%%%

%\newcommand\topspace{\rule{0pt}{5mm}}
%\newcommand\bottomspace{\rule[-5mm]{0pt}{0pt}}
...
\def \Rc         {\text{$R_{\gamma,c}^2$}}
\def \Xg         {\text{$X_{\gamma}$}}
\def \Xgi         {\text{$\bm{x}_{\gamma,i}$}}
\def \pg         {\text{$p_{\gamma}$}}
\def \qg         {\text{$q_{\gamma}$}}
\def \cbvs         {\text{$c_{\mbox{\tiny BVS}}$}}
\def \bg         {\text{\boldmath$\beta$\unboldmath$_{\gamma}$}}
\def \bng         {\text{$\beta$\unboldmath$_{\gamma}$}}
