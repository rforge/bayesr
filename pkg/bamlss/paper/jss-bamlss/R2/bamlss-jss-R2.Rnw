...
Finally, for the Sichel distribution a constant shape parameter is added in th third
...
implementation. Computation times for the more efficient \fct{ztnbinom\_bamlss} family are much lower
with about 7 and 9~minutes for boosting and sampling, respectively.
