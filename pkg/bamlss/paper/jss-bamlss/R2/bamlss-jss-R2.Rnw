...
phase, and apply a thihttps://r-spatial.github.io/sf/#ubuntunning of the resulting chain of $5$.  Running
...
%
Though, the worm plots reveal different tail behaviour of the distributions---
\code{ztSI} and \code{ztnbinom} underestimate the mass of the tail and \code{ztBNB}
slightly overestimates the tail---the distributional model based on the zero
truncated beta negative binomial exhibits the best overall calibration.
