...
<<eval=FALSE>>=
plot(b, which = c("hist-resid", "qq-resid", "wp"), c95 = TRUE)
@
\begin{figure}[!ht]
\centering
...
<<echo=FALSE, fig=TRUE, width=4.5, height=4.7>>=
par(mar = c(4.1, 4.1, 4.1, 1.1))
plot(b, which = "wp", spar = FALSE, c95 = TRUE)
@
...
@
%
The parameters taken directly or derived from ERA5 for this study is only a
small subset of parameters available \citep{era5}. It encloses variables that
are well known to be good canditates for predicting or explaining convective
event that also lead to lightning discharges
\citep[e.g.,][]{bamlss:Simon+Mayr+Umlauf+Zeileis:2019}.
