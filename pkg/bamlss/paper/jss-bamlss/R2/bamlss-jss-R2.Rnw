...
to $1000$. For the sampling we allow another $2000$ iterations as burn-in
phase, and apply a thinning of the resulting chain of $50$.  Running
\code{n.iter = 3000} iterations over \code{cores = 50} cores leads to $1000$ MCMC samples in the
