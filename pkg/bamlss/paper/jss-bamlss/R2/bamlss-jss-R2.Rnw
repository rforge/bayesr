...
\code{SICHEL()} and the beta negative binomial \code{BNB()} are available within
...
negative binomial \code{flash_model_ztnbinom} and zero-truncated Sichel \code{flash_model_ztSICHEL}.
