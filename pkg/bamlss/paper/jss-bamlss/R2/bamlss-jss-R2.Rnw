...
The values of the DIC and WAIC for the 6 models are given in Table~\ref{tab:DIC}.
\begin{table}[h!]
\centering
\begin{tabular}{lcc}
\hline
Family & DIC & WAIC\\ 
\hline
\fct{NO}   & 12291.75 & 12294.20 \\
\fct{GA}   & 12261.06 & 12262.40 \\
\fct{GG}   & 12248.10 & 12249.31 \\
\fct{BCT}  & 12215.85 & 12206.26 \\
\fct{BCCG} & 12190.41 & 12188.05 \\
\fct{BCPE} & \textbf{12188.30} & \textbf{12184.73} \\
\hline
\end{tabular}
\caption{\label{tab:DIC} DIC and WAIC comparison of the 6 distributional cyclical week models.}
\end{table}
Here, the four parameter \fct{BCPE} model has the lowest DIC and WAIC, therefore, we
...
theoretical expectation analytically for filling the diagonals of $\mathbf{W}_{kk}$. The second
option is to find a good approximation for the expectation (see,
