...
hist(fatalities$num, breaks = "Scott", freq = FALSE,
  main = "", xlab = "#Number of fatalities")
...
and estimate a model using the weekly information as a cyclical seasonal effect. We can use the
following model formula for estimation
<<>>=
f <- list(
  num   ~ s(week, k = 20, bs = "cc"),
  sigma ~ s(week, k = 20, bs = "cc"),
  nu    ~ s(week, k = 20, bs = "cc"),
  tau   ~ s(week, k = 20, bs = "cc")
)
@
...
\subsection{Location-scale model v0} \label{sec:distmodel:v0}
