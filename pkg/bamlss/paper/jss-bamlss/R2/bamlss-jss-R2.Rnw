...
\begin{table}[ht!]
\centering
<<para-table, echo=FALSE, results=tex>>=
xt <- xtable::xtable(read.csv2("para-table.csv"),
	caption = "Describtions of the parameters taken directly or derived from ERA5.",
	label = "tab:ecmwf",
    align = c("l", "p{3cm}", "p{12cm}")
)
print(xt, include.rownames = FALSE, floating = FALSE)
@
\caption{\label{tab:desc} Description of selected ERA5 parameters.}
\end{table}
%
