...
\item \emph{page 13, l 4 I am assuming that the priors are trying to be uninformative. How
  ...
  variances in the prior distributions for beta.
...
\item \emph{page 13, l 6 "Univariate responses of any type \dots". The references have a "Bayesian"
  ...
  Yes that is of course correct, thank you, we have listed the reference of course.
...
\item \emph{page 21 l 12 What happens for distributions for which the expectation of the
  ...
  theoretical expectation analytically for filling the diagonals of $\mathbf{W}$. The second
  ...
  in Klein et al 2015 (JASA). We added the paragraph to Section~4.1 now.
