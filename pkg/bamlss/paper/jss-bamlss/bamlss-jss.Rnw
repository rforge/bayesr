...
New link functions can be added via \textbf{CODE}
...
Available smooth terms can be identified via \textbf{CODE} and new smooth terms can be constructed via \textbf{CODE}
