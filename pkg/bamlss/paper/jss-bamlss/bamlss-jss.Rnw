...
plot2d(pForeign ~ age, data = nd, col.lines = "blue", s2.col = myblue,
  add = TRUE, lty = c(2, 1, 2))
@
...
on which the boosting took less than 6~minutes and the MCMC sampling took less than
