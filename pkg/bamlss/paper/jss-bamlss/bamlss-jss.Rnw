...
pathplot(b, 2, spar = FALSE, name = "pi.s.la(cincome).cincome", main = "income", lwd = lwd)
@
<<echo = FALSE, fig = TRUE, width = 4, height = 5, results = hide>>=
par(mar = c(4.1, 4.1, 4.1, 4.1))
pathplot(b, 2, spar = FALSE, name = "pi.s.la(cage).cage", main = "age", lwd = lwd)
@
\newline
<<echo = FALSE, fig = TRUE, width = 4, height = 5, results = hide>>=
par(mar = c(4.1, 4.1, 4.1, 4.1))
pathplot(b, 2, spar = FALSE, name = "pi.s.la(ceducation).ceducation", main = "education", lwd = lwd)
@
<<echo = FALSE, fig = TRUE, width = 4, height = 5, results = hide>>=
par(mar = c(4.1, 4.1, 4.1, 4.1))
pathplot(b, 2, spar = FALSE,
...
pathplot(b, c("loglik.contrib"), intercept = FALSE)
