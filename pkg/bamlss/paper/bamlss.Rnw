...
Scalar covariates & Linear effect $x \cdot \beta$ & \dots & \dots \\
                    & Smooth effect $f(x)$ & \dots & \dots \\
Vector of scalars & Linear interaction $x_1 \cdot x_2 \cdot \beta$ & \dots & \dots \\
                  & Varying coefficient $f(x_2) \cdot x_1$  & \dots & \dots \\
                  & Smooth effect $f(x_1, \ldots, x_m)$  & \dots & \dots \\
Indicator covariates & Random intercept $\beta_i$  & \dots & \dots \\
                     & Spatial effect $f(s)$, $x = s$ & \dots & \dots \\
Scalar and indicator & Random slope $x_1 \cdot \beta_i$ & \dots & \dots \\
                     & Space-time effect $f(t, s)$, $\mathbf{x} = (t, s)$ & \dots & \dots \\
                     & Functional random intercept $f_i(t)$, $x = t$ & \dots & \dots \\
\end{tabular}
\end{table}
