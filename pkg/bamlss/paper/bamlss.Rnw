...
if(!file.exists("figures/firemodel.png")) {
  ...
  png("figures/firemodel.png", units = "in", res = 120, width = 7, height = 6)
...
\includegraphics[width=0.8\textwidth]{figures/firemodel.png}
