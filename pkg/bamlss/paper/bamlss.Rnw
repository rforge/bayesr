...
\boldsymbol{\vartheta}_k^{(t + 1)} = U_k(\boldsymbol{\vartheta}^{(t)}) = \boldsymbol{\vartheta}_k^{(t)} -
...
\vdots & \ddots & \vdots \\
\mathbf{Z}_{p_kk}^\top\mathbf{W}_{kk}\mathbf{Z}_{p_kk} & \cdots & \mathbf{Z}_{p_kk}^\top\mathbf{W}_{kk}\mathbf{Z}_{p_kk} + \mathbf{G}_{p_kk}
\end{pmatrix},
$$
...
\end{pmatrix},
$$
where $\mathbf{u}_k = \partial \ell(\boldsymbol{\vartheta}_k | \mathbf{y}) /
\partial \boldsymbol{\eta}_k$ and $\mathbf{Q}_{jk} = \partial p_{jk}(\boldsymbol{\vartheta}_{jk}) /
