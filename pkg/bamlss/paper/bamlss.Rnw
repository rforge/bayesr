...
epng <- function(file, height = 4, width = 5) {
  png(file, height = height, width = width,
    units = "in", res = 150, bg = "transparent")
}

main <- function(text, side = 3, line = 0.5, cex = 0.8, ...) {
...
For parameters $\boldsymbol{\beta}_k$, the updating scheme can be written as a $k$-partitionedNewton-Raphson iteration
...
\put(6, 3.5){\fcolorbox{black}{heat2}{\framebox(2, 0.7)[c]{\footnotesize Optimizer}}}
\put(6, 2.5){\fcolorbox{black}{heat1}{\framebox(2, 0.7)[c]{\footnotesize Sampler}}}
...
if(!file.exists("figures/rainmodel-effects.png") & FALSE) {
  ...
  epng("figures/rainmodel-data.png", width = 10, height = 4)
  par(mfrow = c(1, 2), mar = c(4.1, 4.1, 1.5, 1.5))
  ...
  epng("figures/rainmodel-effects-season.png", width = 10, height = 4)
  par(mfrow = c(1, 2), mar = c(4.1, 4.1, 1.5, 1.5))
  ...
  legend("topleft", c("Mean effect", "Spatial-varying effect"),
  ...
  epng("figures/rainmodel-effects-spatial.png", width = 10, height = 4)
  par(mfrow = c(1, 2), mar = c(4.1, 4.1, 1.5, 1.5))
  ...
  xymap(long, lat, fmu, data = nd, pos = "topleft", layout = FALSE, map = FALSE,
    ...
    title = expression(paste("Effect on ", mu)), cex.title = 0.9, shift.title = c(0, -4.5))
  ...
  xymap(long, lat, fsigma, data = nd, pos = "topleft", layout = FALSE, map = FALSE,
    ...
    title = expression(paste("Effect on ", log(sigma))), cex.title = 0.9, shift.title = c(0, -4.5))
  plot(Austria, add = TRUE, lwd = 0.3)
  plotUnionAustria(add = TRUE)
  box()
  axis(1)
  ...
  epng("figures/rainmodel-effects-predict.png", width = 10, height = 6)
  par(mar = c(4.1, 4.1, 1.5, 1.5))
  plot(Austria, xlab = "Longitude [deg]", ylab = "Latitude [deg]", lwd = 0.3)
  xymap(long, lat, rain10, data = nd, pos = "topleft", layout = FALSE, map = FALSE,
    add = TRUE, color = colors.rain, shift = c(0.1, 0.02), distance.labels = 0,
    width = 0.3 / 2, height = 0.06 * 4/6, symmetric = FALSE, swap = FALSE, digits = 1, range = c(0, 0.5),
    lrange = round(c(0, max(nd$rain10)), 1),
    title = "Mean precipitation [mm] January 10th", cex.title = 0.9, shift.title = c(0, -4))
  plot(Austria, add = TRUE, lwd = 0.3)
  plotUnionAustria(add = TRUE)
  box()
  axis(1)
...
\begin{figure}[t!]
\centering
\includegraphics[width=0.92\textwidth]{figures/rainmodel-data}
...
\begin{figure}[t!]
\centering
\includegraphics[width=0.92\textwidth]{figures/rainmodel-effects-season} \\
\includegraphics[width=0.92\textwidth]{figures/rainmodel-effects-spatial} \\
...
if(!file.exists("figures/firemodel-data.png")) {
  ...
  png("figures/firemodel-data.png", units = "in", res = 120, width = 8, height = 6.5)
  plot.firedata()
  dev.off()

  epng("figures/firemodel-effects-baseline.png", width = 5, height = 4)
  par(mar = c(4.1, 4.1, 1.5, 1.5))
  plot.firemodel(firemodel_plotdata, what = "curves", main = TRUE)
  dev.off()

  epng("figures/firemodel-effects-fsintens.png", width = 5, height = 4)
  par(mar = c(4.1, 4.1, 1.5, 1.5))
  plot.firemodel(firemodel_plotdata, what = "fsintens", main = TRUE)
  dev.off()

  epng("figures/firemodel-effects-daytime.png", width = 5, height = 4)
  par(mar = c(4.1, 4.1, 1.5, 1.5))
  plot.firemodel(firemodel_plotdata, what = "daytime", main = TRUE)
  dev.off()

  epng("figures/firemodel-effects-prob.png", width = 5, height = 4)
  par(mar = c(4.1, 4.1, 1.5, 1.5))
  plot.firemodel(firemodel_plotdata, what = "spatial_prob", main = TRUE)
  dev.off()

  epng("figures/firemodel-effects-spatial-td.png", width = 5, height = 4)
  par(mar = c(4.1, 4.1, 1.5, 1.5))
  plot.firemodel(firemodel_plotdata, what = "spatial_td", main = TRUE)
  dev.off()

  epng("figures/firemodel-effects-spatial-tc.png", width = 5, height = 4)
  par(mar = c(4.1, 4.1, 1.5, 1.5))
...
\begin{figure}[t!]
\centering
\includegraphics[width=0.46\textwidth]{figures/firemodel-effects-baseline}\includegraphics[width=0.46\textwidth]{figures/firemodel-effects-prob} \\
\includegraphics[width=0.46\textwidth]{figures/firemodel-effects-fsintens}\includegraphics[width=0.46\textwidth]{figures/firemodel-effects-spatial-td} \\
