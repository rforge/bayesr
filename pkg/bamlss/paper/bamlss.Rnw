...
$$
\begin{pmatrix}
\mathbf{X}_{1k}^\top\mathbf{W}_{kk}\mathbf{X}_{1k} - \mathbf{K}_{1k} &
  \cdots & \mathbf{X}_{1k}^\top\mathbf{W}_{kk}\mathbf{X}_{p_kk} \\
\vdots & \ddots & \vdots \\
\mathbf{X}_{p_kk}^\top\mathbf{W}_{kk}\mathbf{X}_{p_kk} & \cdots & \mathbf{X}_{p_kk}^\top\mathbf{W}_{kk}\mathbf{X}_{p_kk} - \mathbf{K}_{p_kk}
\end{pmatrix}^{(t)}
\begin{pmatrix}
...
\end{pmatrix}
= \begin{pmatrix}
\mathbf{X}_{1k}^\top\mathbf{s}_k - \boldsymbol{\beta}_{1k}^{(t)}\frac{1}{2\tau_{1k}^2}\mathbf{K}_{1k} \\
\vdots \\
\mathbf{X}_{p_kk}^\top\mathbf{s}_k - \boldsymbol{\beta}_{p_kk}^{(t)}\frac{1}{2\tau_{p_kk}^2}\mathbf{K}_{p_kk}
\end{pmatrix},
$$
