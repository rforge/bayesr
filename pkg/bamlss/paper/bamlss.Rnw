...
Assuming a basis function approach, updating equation (\ref{eqn:blocknewton}) can be written as
\begin{equation*} \label{eqn:newton2}
\begin{pmatrix}
\mathbf{X}_{1k}^\top\mathbf{W}_{kk}\mathbf{X}_{1k} + \mathbf{G}_{1k} & \cdots & \mathbf{X}_{1k}^\top\mathbf{W}_{kk}\mathbf{X}_{p_kk} \\
\vdots & \ddots & \vdots \\
\mathbf{X}_{p_kk}^\top\mathbf{W}_{kk}\mathbf{X}_{p_kk} & \cdots & \mathbf{X}_{p_kk}^\top\mathbf{W}_{kk}\mathbf{X}_{p_kk} + \mathbf{G}_{p_kk}
\end{pmatrix}^{(t)}
\begin{pmatrix}
...
\end{pmatrix}
= \begin{pmatrix}
\mathbf{s}(\boldsymbol{\vartheta}_{1k}) \\
\vdots \\
\mathbf{s}(\boldsymbol{\vartheta}_{p_kk})
\end{pmatrix}^{(t)}
\end{equation*}
