...
\put(2.5, 3.5){\fcolorbox{black}{heat4}{\framebox(2, 0.7)[c]{\footnotesize Model Frame}}}
...
if(!file.exists("figures/rainmodel-effects.png") & FALSE) {
  ...
  epng("figures/rainmodel-data.png", width = 9, height = 3.5)
  ...
  epng("figures/rainmodel-effects-predict.png", width = 9, height = 5)
  par(mar = c(4.1, 4.1, 1.5, 1.5))
  plot(Austria, xlab = "Longitude [deg]", ylab = "Latitude [deg]", lwd = 0.3)
