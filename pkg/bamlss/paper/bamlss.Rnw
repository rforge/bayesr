...
\put(6, 3.5){\fcolorbox{black}{heat2}{\framebox(4.1, 0.7)[c]{\footnotesize \texttt{optimizer}, e.g., \ref{fig:algodesign} \& \ref{fig:umode}}}}
\put(6, 2.5){\fcolorbox{black}{heat1}{\framebox(4.1, 0.7)[c]{\footnotesize \texttt{sampler}, e.g., \ref{fig:algodesign} \& \ref{fig:mcmc}}}}
