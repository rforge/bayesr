...
if(!file.exists("figures/firemodel-data.png")) {
    ...
    main = NULL, spar = TRUE, ...)
  {
    ...
    if("spatial_prob" %in% what) {
      plot(LondonBoundaries, main = main[2],
    ...
    if("spatial_td" %in% what) {
      plot(LondonBoundaries, main = main[3],
        xlab = "Longitude [deg]", ylab = "Latitude [deg]")
    ...
    if("spatial_tc" %in% what) {
      plot(LondonBoundaries, main = main[4],
        xlab = "Longitude [deg]", ylab = "Latitude [deg]")
    ...
    if("spatial_daytime" %in% what) {
      plot(LondonBoundaries, main = "Spatial daytime effect",
        xlab = "Longitude [deg]", ylab = "Latitude [deg]")
  ...
  plot.firedata <- function()
  {
    ...
    plot.griddata(type = "hexagonal", digits = 0, range = c(-1, 30), lrange = c(1, 40),
      main = "", xlab = "", ylab = "", FUN = length)
    box()
    axis(2)
    ...
    axis(1)
    axis(4)
    mtext("Arrivaltime", side = 1, line = 3)
    mtext("Density", side = 4, line = 3)
    legend("topright", "Histogram of arrivaltime", box.col = NA, bg = NA, cex = 0.95)
