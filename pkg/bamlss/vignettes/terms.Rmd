...
if one is interested in specifying interaction terms, i.e., with main effects and interaction,
e.g., we could do the following using tensor product splines
```{r}
f <- list(
...
first formula. Note again that the number of basis function within `ti()` is small, `k = 5`. The
reason is, that constructing tensor product model terms can easily end up with thousands of
