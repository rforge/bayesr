...
are "Lego bricks" but also estimation algorithms or the MCMC samplers.
...
```{r, fig.width = 5, fig.height = 4, fig.align = "center", dev = "png", out.width="60%"}
...
plot2d(dens$t10 ~ accel, data = mcycle,
  col.lines = rgb(1, 0, 0, alpha = 0.05),
  ylab = "Density")
plot2d(dens$t40 ~ accel, data = mcycle,
  col.lines = rgb(0, 0, 1, alpha = 0.05),
  add = TRUE)
```
