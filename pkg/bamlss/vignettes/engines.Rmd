...
The modeling setup is best explained by looking at the main estimation engines provided bay _bamlss_.
...
The MCMC algorithm consecutively samples for $t = 1, \ldots, T$ from the full conditionals
$$
