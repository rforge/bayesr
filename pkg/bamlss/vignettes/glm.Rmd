...
models (GLM) and has infrastructure for very large data sets, too. First, we illustrate how 
to fit standard GLMs and how to do inference using the _bamlss_ framework. In addition,
we show how to estimate GLMs using very large data set.
...
```
Which indicate convergent of the MCMC chains. Note that this call would show all
